/* checksum : bc9503a75b6fb839953353a384e6de0c */
@cds.external : true
...
entity ZGWSAMPLE_BASIC.BusinessPartnerSet {
  ...
  Address : ZGWSAMPLE_BASIC.CT_Address not null;
  @sap.unicode : 'false'
...
entity ZGWSAMPLE_BASIC.SalesOrderSet {
  ...
  action SalesOrder_Confirm() returns ZGWSAMPLE_BASIC.SalesOrderSet;
  action SalesOrder_Cancel() returns ZGWSAMPLE_BASIC.SalesOrderSet;
  action SalesOrder_InvoiceCreated() returns ZGWSAMPLE_BASIC.SalesOrderSet;
  action SalesOrder_GoodsIssueCreated() returns ZGWSAMPLE_BASIC.SalesOrderSet;
};
